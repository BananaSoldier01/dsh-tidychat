...
function apply(ctx) {
	...
	const TidychatSettingsCard = () => {
		...
		}, "📤 生成诊断报告并提交"), react.createElement("p", { className: "tidychat-field-hint" }, "遇到卡顿等问题时点击：自动生成报告（版本/浏览器/性能数据）并打开 GitHub 新建 issue 页，检查后提交即可。"))) : null);
	};
