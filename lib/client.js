	...
	const TidychatSettingsCard = () => {
		...
		const fields = [
			...
			[
				"navigator",
				"消息轨定位条",
				"会话区边缘的细窄导航，悬停显示摘要、点击跳转到对应消息；贴边与样式可在下方调整。"
			],
			[
				"autoLoad",
				"智能加载更早历史",
		...
		return react.createElement("li", { className: "tidychat-card" + (open ? " tidychat-card-open" : "") }, react.createElement("button", {
			...
			style: { marginTop: "8px" }
		}, react.createElement("span", { className: "tidychat-field-label" }, "显示样式")), chipRow(NAV_STYLE_OPTIONS, String(value.navStyle ?? "bar"), (k) => setColor("navStyle", k), !writable), react.createElement("p", { className: "tidychat-field-hint" }, "位置 = 消息轨贴会话区左缘或右缘，右缘时整体镜像（竖条模式的强调三角指左、摘要卡从左侧弹出）；样式 = 竖条或圆点，圆点模式同样保留悬停鱼眼放大与点击跳转。")), react.createElement("div", {
			key: "navColors",
			className: "tidychat-field"
