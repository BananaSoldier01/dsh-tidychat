...
function apply(ctx) {
	...
	const TidychatSettingsCard = () => {
		...
		}, react.createElement("span", { className: "tidychat-card-headtext" }, react.createElement("span", { className: "tidychat-card-name" }, "@bananasoldier01/dsh-tidychat"), react.createElement("span", { className: "tidychat-card-desc" }, "会话时间线增强：折叠、分隔线、定位条")), react.createElement("svg", {
