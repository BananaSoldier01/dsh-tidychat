...
function apply(ctx) {
	...
	const TidychatSettingsCard = () => {
		...
		return react.createElement("li", { className: "tidychat-card" + (open ? " tidychat-card-open" : "") }, react.createElement("button", {
			...
			style: { marginTop: "8px" }
		}, react.createElement("span", { className: "tidychat-field-label" }, "显示样式")), chipRow(NAV_STYLE_OPTIONS, String(value.navStyle ?? "bar"), (k) => setColor("navStyle", k), !writable), react.createElement("p", { className: "tidychat-field-hint" }, "位置 = 消息轨贴会话区左缘或右缘，右缘时强调三角与摘要卡镜像到左侧；样式 = 竖条或圆点，圆点模式同样保留悬停鱼眼放大与点击跳转。")), react.createElement("div", {
			key: "navColors",
			className: "tidychat-field"
